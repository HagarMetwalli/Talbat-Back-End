        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreAddress = table.Column<int>(type: "int", maxLength: 100, nullable: false),
                    StoreTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
<<<<<<< HEAD:Migrations/20210609165547_first.cs
                name: "Invoice",
                columns: table => new
                {
...
=======
                ...
                columns: table => new
                {
                    ClientId = table.Column<int>(type: "int", nullable: false),
                    CouponId = table.Column<int>(type: "int", nullable: false),
>>>>>>> origin/BlaBla:Migrations/20210614203127_blabla.cs
                    OrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
